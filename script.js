...
function clearLines() {
    ...
    if(lines > 0) {
        ...
        else if(score >= 2000) levelMessage.textContent = "Bruno sigue siendo el mejor";
        else if(score >= 3000) levelMessage.textContent = "¡3.000 puntos!";
        else if(score >= 4000) levelMessage.textContent = "¡4.000 puntos!";
        else if(score >= 5000) levelMessage.textContent = "Ya no hay más, no sigsas";
    }
}
